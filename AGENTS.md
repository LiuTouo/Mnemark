...
This project is indexed by GitNexus as **Mnemark** (2978 symbols, 9318 relationships, 257 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
