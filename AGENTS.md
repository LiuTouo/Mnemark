...
This project is indexed by GitNexus as **Mnemark** (2720 symbols, 8869 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
