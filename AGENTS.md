...
This project is indexed by GitNexus as **Mnemark** (2650 symbols, 8654 relationships, 231 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
