...
This project is indexed by GitNexus as **Mnemark** (1765 symbols, 10810 relationships, 148 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
