...
This project is indexed by GitNexus as **Mnemark** (1455 symbols, 4518 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
