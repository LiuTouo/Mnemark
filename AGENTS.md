...
This project is indexed by GitNexus as **Mnemark** (2722 symbols, 8865 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
