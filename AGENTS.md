...
This project is indexed by GitNexus as **Mnemark** (1504 symbols, 5816 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
