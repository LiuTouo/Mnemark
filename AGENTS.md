...
This project is indexed by GitNexus as **Mnemark** (3061 symbols, 9569 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
