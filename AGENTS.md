...
This project is indexed by GitNexus as **Mnemark** (1548 symbols, 8537 relationships, 131 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
