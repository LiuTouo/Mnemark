...
This project is indexed by GitNexus as **Mnemark** (1663 symbols, 9472 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
